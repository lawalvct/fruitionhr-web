...
const nav: NavItem[] = [
  ...
  { group: "Company", href: "/billing", label: "Billing", icon: CreditCard, permission: "billing.view" },
  { group: "Company", href: "/support", label: "Support", icon: LifeBuoy, permission: "support.view" },
